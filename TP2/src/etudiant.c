...
int main() {
    ...
    char prenom[][15] = {"Arnaud", "Bob", "Charles", "Denis", "Esteban"}; //création liste des prénoms
    char adresse[][15] = {"1 rue a", "2 rue b", "3 rue c", "4 rue d", "5 rue e"}; //création liste des adresses
